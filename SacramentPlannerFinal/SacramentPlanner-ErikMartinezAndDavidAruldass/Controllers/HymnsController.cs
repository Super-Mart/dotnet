...
namespace SacramentPlanner_ErikMartinezAndDavidAruldass.Controllers
{
    public class HymnsController : Controller
    {
        ...
        public HymnsController(Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("HymnId,HymnName,HymnNumber")] Hymn hymn)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("HymnId,HymnName,HymnNumber")] Hymn hymn)
        {
            if (id != hymn.HymnId)
            {
                return NotFound();
