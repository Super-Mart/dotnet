...
namespace SacramentPlanner_ErikMartinezAndDavidAruldass.Controllers
{
    public class MembersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("MemberId,MemberName")] Member member)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("MemberId,MemberName")] Member member)
        {
